...
<script type="text/javascript">
	...
	function login() {
		...
		var validateCode1 = $("#validateCode").val();
		if (loginName1 == '' || password1 == '' || validateCode1 == '') {
		...
		<div class="wid land_1">
			...
			<div class="login">
				<form id="loginForm" action="login.jsp" method="post">
					...
					<p
						style="margin-left:100px;margin-top:60px;color:red;font-size:16px"
						id="tips"></p>
				...
				<div class="position">
					还没有修配连账号吗？赶快<span><a
						href="${ctx}/register/toRegister.shtml?method=toRegister">点击注册</a></span>加入我们吧！
				</div>
			</div>
		</div>
		<div class="clear"></div>
